...
tokenizer = AutoTokenizer.from_pretrained("./bert/modelo-bert",local_files_only=True)
model = AutoModelForQuestionAnswering.from_pretrained("./bert/modelo-bert",local_files_only=True)
reader = PdfReader("./bert/contenido.pdf")
text = ""
...
class ActionDefaultFallback(Action):
    ...
    def run(self,dispatcher: CollectingDispatcher,
        ...
        dispatcher.utter_message(text='No se encontro una respuesta adecuada intenta otra pregunta')
